...
public class MethodMain02 {
    ...
    public static void main(String[] args) {
        ...
        double s = subtract(2.0,5.0);
        
        System.out.println("뺄셈 결과 : "+s);
        
        double m = multiply(8.0,3.0);
        
        System.out.println("곱셈 결과 : "+m);
        
        
        System.out.println("나눗셈 결과 : "+ divide(10.0,3.0));  // 이렇게도 가능!
