...
public interface ContactDao {
	...
	int MAX_LENGTH = 3; //public static final
	...
	//파라미터  str, str, str(good) / str[](not good) / Contact contact(good) 등의 방식으로 가능.
	
	
	/**
	 * 연락처 삭제 기능. 해당 인덱스의 연락처를 리스트에서 삭제
	 * 바뀐 리스트의 내용을 파일에 저장.
	 * @param index 리스트에서 삭제할 연락처의 인덱스 (0이상의 정수)
